...
const DEFAULT_AI_SETTINGS = [
  ...
  },
  {
    ...
    service: "protalk-image",
    prompt: "Обнови горизонтальный портрет славянского духа по имени {name} ({gender}), стиль: {style}. Лор: {lore}. Ранее купленные предметы: {inventory}. НОВЫЙ предмет: {new_item}. Нарисуй обновлённый портрет с новым предметом. Особые приметы: {wishes}. Горизонтальная ориентация. Высокое качество.",
    instruction: "Вызывается после покупки предмета в магазине. Используй {new_item} — название только что купленного предмета, {inventory} — весь инвентарь. Обязательна горизонтальная ориентация.",
  },
  {
    section_id: "names",
    name: "Генерация Имён",
